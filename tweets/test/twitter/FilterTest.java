...
public class FilterTest {
    ...
    private static final Tweet tweet3 = new Tweet(2, "ahsan", "hello world talk #hype", d2);
    private static final Tweet tweet4= new Tweet(2, "alyssa", "hello world talk #hype", d2);
